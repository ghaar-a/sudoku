...
public class Main {
    ...
    private static void startGame(Map<String, String> positions) {
        ...
        System.out.println("O jogo ja ta pronto para começar");
    }
    ...
    private static void clearGame() {
        ...
        System.out.println("Tem certeza que deseja limpar e perder todo seu progresso?");
    ...
    private static void finishGame() {
        ...
        if (board.gameIsFinished()){
            ...
            System.out.println("seu jogo contém erros, verifique seu board e ahuste-o");
        } else {
